...
useEffect(() => {
    var typed = new Typed(el.current, {
        strings: ['trbshyguy1100', 'trbsh', 'tarboucha', 'an overthinker', 'a nerd', 'keyboard masher'],
        typeSpeed: 50,
        backSpeed: 50,
        loop: true
    });
    ...
    return (
        <section id="intro">
            <div className="intro-text">
                ...
                <h1 className="intro-title">I'm <span className="intro-title-highlight">trbshyguy1100</span></h1>
